...
\newcommand{\clsdiagram}[2][1.0]{\textbf{Class diagram:} \newline 
\begin{center}
...
\input{chapter/Classes/DummyNamespace/DummyNamespace}
\newpage
\input{chapter/Classes/Core/Core}
\newpage
\input{chapter/Classes/Modules/Modules}
\newpage
\input{chapter/Classes/Common/Common}
\newpage
\input{chapter/Classes/BrowserExtension/BrowserExtension}

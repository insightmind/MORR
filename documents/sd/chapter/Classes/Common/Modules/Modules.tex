...
\begin{interface}{IModule}
    \clsdiagram{resources/Classes/Common/Shared/Modules/IModule.png}
...
\begin{interface}{ICollectingModule}
    \clsdiagram{resources/Classes/Common/Shared/Modules/ICollectingModule.png}
...
\begin{interface}{ITransformingModule}
    \clsdiagram{resources/Classes/Common/Shared/Modules/ITransformingModule.png}
...
\begin{interface}{IReceivingModule}
    \clsdiagram{resources/Classes/Common/Shared/Modules/IReceivingModule.png}

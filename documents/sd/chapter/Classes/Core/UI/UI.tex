...
\begin{class}{ApplicationViewModel}
    ...
    \clsdsp{The controller that connects the view to the model}
...
\begin{class}{RelayCommand}
	...
	\begin{constructors}
        ...
        \begin{parameters}
                ...
                \para{Predicate<object>? canExecute = null}{An optional predicate that needs to be fulfilled before the command can be executed}
        \end{constructor}
     \end{constructors}

...
\begin{class}{ProcessOptions}
	...
	\clsdsp{The ProcessOptions contain all options which can be entered by the user when calling the command. In this case the command is the ProcessCommand. }

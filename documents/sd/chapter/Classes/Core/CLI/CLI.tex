...
\begin{class}{InteractiveCommandline}
	\clsdiagram[width=0.3\textwidth]{resources/Classes/Core/CLI/InteractiveCommandline.png}
...
\begin{class}{ValidateCommand}
	\clsdiagram[width=0.3\textwidth]{resources/Classes/Core/CLI/ValidateCommand.png}
...
\begin{class}{ProcessCommand}
	\clsdiagram[width=0.3\textwidth]{resources/Classes/Core/CLI/ProcessCommand.png}
...
\begin{class}{ProcessCommand}
	\clsdiagram[width=0.3\textwidth]{resources/Classes/Core/CLI/RecordCommand.png}

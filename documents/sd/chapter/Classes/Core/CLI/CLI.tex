	...
	\begin{methods}
		\begin{method}{public void PrintMessage(string message, bool verbose)}{\\ Prints the message to the command line. It also filters out based on the verbosity of the message}
			\begin{parameters}
				...
				\para{bool verbose}{\\ The verbosity of the message. If it is false it will alwats be printed to the command line. Otherwise it will only be printed if the formatter is set to verbose itself.}
			\end{parameters}
...
\end{class}
\input{chapter/Classes/Core/CLI/Classes/Command}
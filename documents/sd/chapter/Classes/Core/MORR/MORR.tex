...
\begin{class}{RecordingManager}
    \clsdiagram{resources/Classes/Core/MORR/RecordingManager.png}

    \clsdcl{public class RecordingManager}
...
\begin{class}{RecordingException}
    \clsdiagram{resources/Classes/Core/MORR/RecordingException.png}
...
\begin{class}{AlreadyRecordingException}
    \clsdiagram{resources/Classes/Core/MORR/AlreadyRecordingException.png}
...
\begin{class}{NotRecordingException}
    \clsdiagram{resources/Classes/Core/MORR/NotRecordingException.png}
...
\begin{class}{Bootstrapper}
    ...
    \clsdcl{public class Bootstrapper}
...
\begin{class}{ConfigurationManager}
    \clsdiagram{resources/Classes/Core/MORR/ConfigurationManager.png}

    \clsdcl{public class ConfigurationManager}
...
\begin{class}{InvalidConfigurationException}
    \clsdiagram{resources/Classes/Core/MORR/InvalidConfigurationException.png}
...
\begin{class}{ModuleManager}
    \clsdiagram{resources/Classes/Core/MORR/ModuleManager.png}

    \clsdcl{public class ModuleManager}
...
\begin{class}{GlobalModuleConfiguration}
    \clsdiagram{resources/Classes/Core/MORR/GlobalModuleConfiguration.png}

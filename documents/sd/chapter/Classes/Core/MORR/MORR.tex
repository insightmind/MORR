...
\begin{interface}{IRecordingManager}
    ...
    \begin{methods}
        ...
        \begin{method}{public void StopRecording()}{Stops a recording if a session is currently being recorded.}
            ...
            \end{exceptions}
        \end{method}
        \begin{method}{public void StartDecoding()}{Starts the encoding process.}
        \end{method}
        \begin{method}{public void StopDecoding()}{Stops the encoding process.}
        \end{method}
    \end{methods}
\end{interface}

\begin{class}{RecordingManager}
    \clsdiagram[width=0.45\textwidth]{resources/Classes/Core/MORR/RecordingManager.png}
    ...
    \begin{attributes}
        ...
        \attribute{private IMetadataCapture metadataCapture}{The IMetadataCapture instance that provides MetadataSamples to the used encoder during a recording.}
        \attribute{private IMetadataDeserializer metadataDeserializer}{The IMetadataDeserializer instance that provides specific events from the decoded MetadataSamples of the decoder.}
    \end{attributes}
    ...
    \begin{methods}
        ...
        \begin{method}{public void StopRecording()}{Stops a recording if a session is currently being recorded.}
            ...
            \end{exceptions}
        \end{method}
        \begin{method}{public void StartEncoding()}{Starts the encoding process.}
        \end{method}
        \begin{method}{public void StopEncoding()}{Stops the encoding process.}
        \end{method}
    \end{methods}
\end{class}
...
\begin{interface}{IBootstrapper}
    ...
    \begin{methods}
        \begin{method}{void ComposeImports(object @object)}{Satisifies the imports on the specified object using MEF.}
        \begin{parameters}
...
\begin{interface}{IConfigurationManager}
    ...
    \begin{methods}
        \begin{method}{void LoadConfiguration(string path)}{Loads the configuration in .json format from the specified part and initializes all IConfiguration instances.}
            \begin{parameters}
...
\begin{interface}{IModuleManager}
    ...
    \begin{methods}
        \begin{method}{void InitializeModules()}{Initializes all modules according to the configuration}      
        \end{method}
    \end{methods}
\end{interface}

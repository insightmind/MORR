...
\begin{class}{VideoSampleRequestedEventHandler}
    \clsdiagram{resources/Classes/Core/MORR/Transcoding/Video/VideoSampleRequestedEventHandler.png}
...
\begin{class}{VideoSampleDecodedEventHandler}
    \clsdiagram{resources/Classes/Core/MORR/Transcoding/Video/VideoSampleDecodedEventHandler.png}
...
\begin{class}{VideoEncodingException}
    \clsdiagram{resources/Classes/Core/MORR/Transcoding/Video/VideoEncodingException.png}
...
\begin{class}{VideoDecodingException}
    \clsdiagram{resources/Classes/Core/MORR/Transcoding/Video/VideoDecodingException.png}

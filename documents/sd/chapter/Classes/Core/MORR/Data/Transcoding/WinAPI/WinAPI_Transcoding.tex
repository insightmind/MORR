...
\begin{class}{MPEGEncoder}
    \clsdiagram{resources/Classes/Core/MORR/Transcoding/WinAPI/MPEGEncoder.png}
...
\begin{class}{MPEGEncoderConfiguration}
    \clsdiagram{resources/Classes/Core/MORR/Transcoding/WinAPI/MPEGEncoderConfiguration.png}
...
\begin{class}{MPEGDecoder}
    \clsdiagram{resources/Classes/Core/MORR/Transcoding/WinAPI/MPEGDecoder.png}
...
\begin{class}{MPEGDecoderConfiguration}
    \clsdiagram{resources/Classes/Core/MORR/Transcoding/WinAPI/MPEGDecoderConfiguration.png}

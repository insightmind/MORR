...
\begin{class}{DesktopCaptureConfiguration}
    ...
    \begin{attributes}
        \attribute{public Index MonitorIndex \{ get; set;\}}{The index of the monitor to capture.}
        \attribute{public bool PromptUserForMonitorSelection \{ get; set;\}}{Indicates whether the user should be prompted to manually select the monitor to capture. True if the user should be prompted, false otherwise.}
    \end{attributes}

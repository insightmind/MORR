...
\begin{class}{CaptureException}
    \clsdiagram{resources/Classes/Core/MORR/Capture/CaptureException.png}
...
\begin{class}{VideoCaptureException}
    \clsdiagram{resources/Classes/Core/MORR/Capture/VideoCaptureException.png}
...
\begin{interface}{IVideoCapture}
    \clsdiagram{resources/Classes/Core/MORR/Capture/IVideoCapture.png}
...
\begin{interface}{DesktopCapture}
    \clsdiagram{resources/Classes/Core/MORR/Capture/DesktopCapture.png}
...
\begin{class}{DesktopCaptureConfiguration}
    \clsdiagram{resources/Classes/Core/MORR/Capture/DesktopCaptureConfiguration.png}
...
\begin{class}{CaptureHelper}
    \clsdiagram{resources/Classes/Core/MORR/Capture/CaptureHelper.png}
...
\begin{class}{Direct3D11Helper}
    \clsdiagram{resources/Classes/Core/MORR/Capture/Direct3D11Helper.png}
...
\begin{class}{MonitorEnumerationHelper}
    \clsdiagram{resources/Classes/Core/MORR/Capture/MonitorEnumerationHelper.png}
...
\begin{class}{MonitorInfo}
    \clsdiagram{resources/Classes/Core/MORR/Capture/MonitorInfo.png}

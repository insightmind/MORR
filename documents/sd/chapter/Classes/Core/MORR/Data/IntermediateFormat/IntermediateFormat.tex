...
\begin{class}{JsonIntermediateFormatSerializer}
    \clsdiagram[width=\textwidth]{resources/Classes/Core/MORR/Data/IntermediateFormat/Json/JsonIntermediateFormatSerializer.png}

    \clsdcl{public class JsonIntermediateFormatSerializer : \linebreak DefaultEncodeableEventQueue<JsonIntermediateFormatSample>, IModule}

...
\begin{constructors}
\begin{constructor}{constructor(callback : function(BrowserEvent) : void, configurationString : string)}{Initialize the ListenerManager and therefore all configured listeners.}
\begin{parameters}
\para{callback : function(Shared.BrowserEvent) : void}{The callback function to pass to the managed listeners.}

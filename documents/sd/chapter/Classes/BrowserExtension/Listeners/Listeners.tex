...
\return{OpenTabEvent}{A OpenTabEvent.}
\begin{parameters}
...
\para{sender? : chrome.runtime.MessageSender}{The sender object of the serialized data. Will issually be a tabs.Tab.}
\end{parameters}
\end{method}
\end{methods}
\end{class}
...
\begin{methods}
\begin{method}{createEvent(downloadItem: downloads.DownloadItem) : Promise<DownloadEvent>}{Asynchronously create a new DownloadEvent from a downlaods.DownLoadItem}

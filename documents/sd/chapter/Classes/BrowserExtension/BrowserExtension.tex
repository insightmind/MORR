...
\begin{parameters}
\para{string configurationString}{A valid JSON string containing optional configuration. The configuration determines whether specific event types shall be recorded or not.}
\end{parameters}
\end{constructor}
\end{constructors}
\begin{methods}

...
\begin{absclass}{MouseEvent} 
    ...
    \begin{attributes}
    	\attribute{public Point MousePosition}{The current position of the mouse in screen coordinates}
    \end{attributes}
\end{absclass}
...
\begin{class}{MouseClickEvent} 
    ...
    \begin{attributes}
        \attribute{public MouseAction MouseAction}{Specifies constants that define actions performed by the mouse.}
...
\begin{class}{MouseMoveEventProducer} 
    ...
    \begin{methods}
        \begin{method}{public void StartCapture()}{Starts capturing mouse move events}
        \end{method}

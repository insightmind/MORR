...
\begin{class}{WindowManagementModule} 
    \clsdiagram[width=0.80\textwidth]{resources/Classes/Modules/WindowManagement/WindowManagementModule.png}
...
\begin{class}{WindowFocusEventProducer} 
	\clsdiagram[scale = 0.9]{resources/Classes/Modules/WindowManagement/Producers/WindowFocusEventProducer.png}
...
\begin{class}{WindowMovementEventProducer} 
	\clsdiagram[scale = 0.9]{resources/Classes/Modules/WindowManagement/Producers/WindowMovementEventProducer.png}
...
\begin{class}{WindowResizingEventProducer} 
	\clsdiagram[scale = 0.9]{resources/Classes/Modules/WindowManagement/Producers/WindowResizingEventProducer.png}
...
\begin{class}{WindowStateChangedEventProducer} 
	\clsdiagram[scale = 0.9]{resources/Classes/Modules/WindowManagement/Producers/WindowStateChangedEventProducer.png}

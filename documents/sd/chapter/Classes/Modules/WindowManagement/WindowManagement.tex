...
\begin{class}{WindowMovementEvent} 
    ...
    \begin{attributes}
        \attribute{public Point OldLocation}{The old location of the window.}
        \attribute{public Point NewLocation}{The new location of the window.}
    \end{attributes}
\end{class}
...
\begin{class}{WindowResizingEvent} 
    ...
    \begin{attributes}
        \attribute{public Size OldSize}{The old size of the window.}
        \attribute{public Size NewSize}{The new size of the window.}
    \end{attributes}
\end{class}
...
\begin{class}{WindowStateChangedEvent} 
    ...
    \begin{attributes}
        \attribute{public WindowState State}{The new state of the window.}
    \end{attributes}
\end{class}
...
\begin{class}{WindowFocusEventProducer} 
    ...
    \begin{methods}
        \begin{method}{public void StartCapture()}{Starts capturing window focus events}
        \end{method}
...
\begin{class}{WindowMovementEventProducer} 
    ...
    \begin{methods}
    	\begin{method}{public void StartCapture()}{Starts capturing window movement events}
        \end{method}
...
\begin{class}{WindowResizingEventProducer} 
    ...
    \begin{methods}
        \begin{method}{public void StartCapture()}{Starts capturing window resizing events}
        \end{method}
...
\begin{class}{WindowStateChangedEventProducer} 
    ...
    \begin{methods}
        \begin{method}{public void StartCapture()}{Starts capturing window state changed events}
        \end{method}

...
\begin{class}{WindowManagementModule} 
    ...
    \clsdcl{public class WindowManagementModule}
...
\begin{class}{WindowMovementEvent} 
    ...
    \begin{attributes}
        \attribute{public Vector2 OldLocation}{The old location of the window.}
        \attribute{public Vector2 NewLocation}{The new location of the window.}
    \end{attributes}
\end{class}

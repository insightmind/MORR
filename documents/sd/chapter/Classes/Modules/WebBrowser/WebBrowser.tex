...
\begin{class}{WebBrowserModule} 
	\clsdiagram[scale = 0.45]{resources/Classes/Modules/WebBrowser/WebBrowserModule.png}
...
\begin{class}{ButtonClickEventProducer : EventQueue<ButtonClickEvent>} 
    ...
    \begin{methods}
        ...
        \begin{method}{protected override void Enqueue(ButtonClickEvent event)}{Asynchronously enqueues a new button click event}
            \begin{parameters}
                \para{ButtonClickEvent event}{ButtonClickEvent to enqueue}
            \end{parameters}
        \end{method}
    \end{methods}
\end{class}
...
\begin{class}{CloseTabEventProducer} 
    ...
    \clsdcl{public class CloseTabEventProducer : EventQueue<CloseTabEvent>}
    ...
    \begin{methods}
        ...
        \begin{method}{protected override void Enqueue(CloseTabEvent event)}{Asynchronously enqueues a new close tab event}
            \begin{parameters}
                \para{CloseTabEvent event}{CloseTabEvent to enqueue}
            \end{parameters}
        \end{method}
    \end{methods}
\end{class}
...
\begin{class}{FileDownloadEventProducer} 
    ...
    \clsdcl{public class FileDownloadEventProducer : EventQueue<FileDownloadEvent>}
    ...
    \begin{methods}
        ...
        \begin{method}{protected override void Enqueue(FileDownloadEvent event)}{Asynchronously enqueues a new file download event}
            \begin{parameters}
                \para{FileDownloadEvent event}{FileDownloadEvent to enqueue}
            \end{parameters}
        \end{method}
    \end{methods}
\end{class}
...
\begin{class}{HoverEventProducer} 
    ...
    \clsdcl{public class HoverEventProducer : EventQueue<HoverEvent>}
    ...
    \begin{methods}
        ...
        \begin{method}{protected override void Enqueue(HoverEvent event)}{Asynchronously enqueues a new hover event}
            \begin{parameters}
                \para{HoverEvent event}{HoverEvent to enqueue}
            \end{parameters}
        \end{method}
    \end{methods}
\end{class}
...
\begin{class}{NavigationEventProducer} 
    ...
    \clsdcl{public class NavigationEventProducer : EventQueue<NavigationEvent>}
    ...
    \begin{methods}
        ...
        \begin{method}{protected override void Enqueue(NavigationEvent event)}{Asynchronously enqueues a new navigation event}
            \begin{parameters}
                \para{NavigationEvent event}{NavigationEvent to enqueue}
            \end{parameters}
        \end{method}
    \end{methods}
\end{class}
...
\begin{class}{OpenTabEventProducer} 
    ...
    \clsdcl{public class OpenTabEventProducer : EventQueue<OpenTabEvent>}
    ...
    \begin{methods}
        ...
        \begin{method}{protected override void Enqueue(OpenTabEvent event)}{Asynchronously enqueues a new open tab event}
            \begin{parameters}
                \para{OpenTabEvent event}{OpenTabEvent to enqueue}
            \end{parameters}
        \end{method}
    \end{methods}
\end{class}
...
\begin{class}{SwitchTabEventProducer} 
    ...
    \clsdcl{public class SwitchTabEventProducer : EventQueue<SwitchTabEvent>}
    ...
    \begin{methods}
        ...
        \begin{method}{protected override void Enqueue(SwitchTabEvent event)}{Asynchronously enqueues a new switch tab event}
            \begin{parameters}
                \para{SwitchTabEvent event}{SwitchTabEvent to enqueue}
            \end{parameters}
        \end{method}
    \end{methods}
\end{class}
...
\begin{class}{TextInputEventProducer} 
    ...
    \clsdcl{public class TextInputEventProducer : EventQueue<TextInputEvent>}
    ...
    \begin{methods}
        ...
        \begin{method}{protected override void Enqueue(TextInputEvent event)}{Asynchronously enqueues a new text input event}
            \begin{parameters}
                \para{TextInputEvent event}{TextInputEvent to enqueue}
            \end{parameters}
        \end{method}
    \end{methods}
\end{class}
...
\begin{class}{TextSelectionEventProducer} 
    ...
    \clsdcl{public class TextSelectionEventProducer : EventQueue<TextSelectionEvent>}
    ...
    \begin{methods}
        ...
        \begin{method}{protected override void Enqueue(TextSelectionEvent event)}{Asynchronously enqueues a new text selection event}
            \begin{parameters}
                \para{TextSelectionEvent event}{TextSelectionEvent to enqueue}
            \end{parameters}
        \end{method}
    \end{methods}
\end{class}

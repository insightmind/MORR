...
\chapter{Features}
This chapter provides information on the implementation status of the features/specifications listed in the function specification document.
...
\feature{FS330 - Event-Data extraction}{\cancelled}{As the data is directly serialized to a JSON while recording, this feature is no longer needed.}

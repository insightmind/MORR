...
\begin{tests}
    ...
    \test{\fmt{FS120}{FS250}}{Save dialog - Quit and save}{The application is currently showing the save dialog and the \gls{user} has clicked on the "Quit" entry in the tray menu.}
    {\begin{enumerate}
    ...
    \test{\fmt{FS120}{FS250}}{Save dialog - Quit and discard}{The application is currently showing the save dialog and the \gls{user} has clicked on the "Quit" entry in the tray menu.}
    {\begin{enumerate}
...
\begin{tests}
    ...
    {\begin{enumerate}
        \item The \gls{user} starts a recording.
        \item The \gls{user} accepts the information dialog.
    \end{enumerate}}
    {\begin{itemize}
        \item The application shows a recording indicator.
    \end{itemize}}

    \test{\fmt{FS310}}{Error dialog}{The application is not running. The configuration file is invalid.}
    {\begin{enumerate}
        \item The \gls{user} starts the application.
    \end{enumerate}}
    {\begin{itemize}
        \item The application shows an error dialog.
    \end{itemize}}

    \test{\fmt{FS70}{FS90}{FS120}{FS320}{FS340}{FS350}}{Save dialog}{The application is running. The configuration file is valid.}
    {\begin{enumerate}
        \item The \gls{user} starts a recording.
        \item The \gls{user} stops the recording.
    \end{enumerate}}

...
\begin{tests}
    ...
    {\begin{itemize}
        ...
        \item The recording contains both events in accordance with \specref{D300}, \specref{D301} and \specref{D302}. The timestamp of the first \gls{event} must refer to time X, the timestamp of the second \gls{event} must refer to time Y.
    \end{itemize}}
...
\begin{tests}
    ...
    \end{enumerate}}
    {\begin{itemize}
        \item The \gls{event} data contained in the recordings at path X is extracted in CSV-format to path Y.
    \end{itemize}}

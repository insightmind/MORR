...
\begin{itemize}
	\ospec{\Gls{session} duration}{Minimal/maximal recording duration of the \gls{session} can be set.}
	...
	\ospec{Website-specific event type filtering}{The types of the recorded \glspl{event} can be filtered for any website.}
\end{itemize}

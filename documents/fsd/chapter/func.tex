...
\begin{specifications}
    ...
    \spec{On-demand module detection\\The application core is responsible for listening to incoming connections from on-demand modules which are realized as extensions to third party software, such as browser-extensions.}

...
The buttons  in scenario 1 to 4 are specified in \autoref{ch:sysmodels} with the functions specified in \specref{FS50}.\\
The yellow border in scenario 1 to 4 are specified in \autoref{ch:sysmodels} with the function specified in \specref{FS60}.

...
\section{Sessions}
\begin{data}
\spec{All sessions are stored locally in a file-based format and may be uploaded to remote storage. }
...
\begin{data}
\spec{A generic Window-Management event must include the following data:
	\begin{itemize}
...
\spec{A Button-Click Browser event must include the following additional data:
	\begin{itemize}

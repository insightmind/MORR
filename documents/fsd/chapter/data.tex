...
\dsubspec{An Open-tab \gls{event} includes only the generic event data.}
...
\dsubspec{A Close-tab \gls{event} must include only the generic event data.}

\dsubspec{A Navigation \gls{event} must include only the generic event data.}

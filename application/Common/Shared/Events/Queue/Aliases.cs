...
namespace MORR.Shared.Events.Queue
{
    ...
    /// </summary>
    /// <typeparam name="T">The type of <see cref="Event" /> in this queue.</typeparam>
    public abstract class DefaultEncodableEventQueue<T> : BaseEventQueue<T>, IEncodableEventQueue<T> where T : Event
    {
    ...
    /// </summary>
    /// <typeparam name="T">The type of <see cref="Event" /> in this queue.</typeparam>
    public abstract class DefaultDecodableEventQueue<T> : BaseEventQueue<T>, IDecodableEventQueue<T> where T : Event
    {
    ...
    /// </summary>
    /// <typeparam name="T">The type of <see cref="Event" /> in this queue.</typeparam>
    public abstract class NonDeserializableEventQueue<T> : BaseEventQueue<T>, IReadOnlyEventQueue<T> where T : Event
    {

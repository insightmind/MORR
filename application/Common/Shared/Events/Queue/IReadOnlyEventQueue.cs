...
{
    /// <summary>
    ///     Provides read-only access to a queue of events as concrete type <typeparamref name="T" />v
    /// </summary>
    /// <typeparam name="T">The concrete type of the event</typeparam>
    public interface IReadOnlyEventQueue<out T> where T : Event
    {
        /// <summary>
        ///     Asynchronously gets all events as concrete type <typeparamref name="T" />v
        /// </summary>
